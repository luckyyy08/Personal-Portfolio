            ...
            <div class="col-lg-5" data-aos="fade-right">
                <div class="custom-card h-100">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0" style="width: 50px; height: 50px; border-radius: 50%; background: rgba(99, 102, 241, 0.1); color: var(--primary-color); font-size: 1.2rem;">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0" style="width: 50px; height: 50px; border-radius: 50%; background: rgba(236, 72, 153, 0.1); color: var(--accent-color); font-size: 1.2rem;">
                            <i class="fa-solid fa-envelope"></i>
                        </div>
                        <div class="ms-3">
                            <h5 class="fw-bold mb-1">Email</h5>
                            <a href="mailto:lokeshahire85@gmail.com" class="text-muted text-decoration-none">lokeshahire85@gmail.com</a>
                        </div>
                    </div>
                    
                    <div class="d-flex align-items-center mb-5">
                        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0" style="width: 50px; height: 50px; border-radius: 50%; background: rgba(139, 92, 246, 0.1); color: var(--secondary-color); font-size: 1.2rem;">
            ...
            <div class="col-lg-7" data-aos="fade-left">
                <div class="custom-card">
                    ...
                    <form action="https://formsubmit.co/lokeshahire85@gmail.com" method="POST" class="needs-validation">
                        ...
                        <input type="hidden" name="_next" value="http://<?php echo $_SERVER['HTTP_HOST'] . $_SERVER['PHP_SELF']; ?>">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="subject" name="subject" placeholder="Freelance Project Inquiry">
                            </div>
                            <div class="col-12">
                                <label for="message" class="form-label fw-medium">Message <span class="text-danger">*</span></label>
                                <textarea class="form-control" id="message" name="message" rows="5" required placeholder="Hello, I would like to discuss..."></textarea>
                            </div>
                            <div class="col-12 mt-4">
                                <button type="submit" name="submit_contact" class="btn btn-gradient px-5 py-3 rounded-pill w-100 fw-bold">
