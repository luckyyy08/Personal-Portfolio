    ...
    <div class="container">
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="0">
                <div class="custom-card p-0 overflow-hidden d-flex flex-column h-100">
                    <div class="position-relative overflow-hidden group">
                        <img src="https://images.unsplash.com/photo-1556910103-1c02745a872f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="CakeCraft Bakery" class="img-fluid w-100 object-fit-cover" style="height: 200px; transition: transform 0.5s;">
                    ...
                    <div class="p-4 d-flex flex-column flex-grow-1">
                        ...
                        <p class="text-muted mb-4 flex-grow-1">A complete bakery e-commerce platform with product management, cart functionality, and secure checkout.</p>
                        ...
                        <div class="d-flex gap-2 mt-auto">
                            <a href="#" class="btn btn-sm btn-outline-theme flex-grow-1"><i class="fa-solid fa-link me-1"></i> Live Demo</a>
                            <a href="#" class="btn btn-sm btn-dark flex-grow-1"><i class="fa-brands fa-github me-1"></i> Code</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="custom-card p-0 overflow-hidden d-flex flex-column h-100">
                    <div class="position-relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1592210454359-9043f067919b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Weather App" class="img-fluid w-100 object-fit-cover" style="height: 200px;">
                        <div class="position-absolute top-0 end-0 p-3">
                    ...
                    <div class="p-4 d-flex flex-column flex-grow-1">
                        ...
                        <p class="text-muted mb-4 flex-grow-1">A responsive weather application utilizing OpenWeather API to display current conditions and 5-day forecasts.</p>
                        <div class="d-flex flex-wrap gap-2 mb-4">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="custom-card p-0 overflow-hidden d-flex flex-column h-100">
                    <div class="position-relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1499750310107-5fef28a66643?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Blog System" class="img-fluid w-100 object-fit-cover" style="height: 200px;">
                        <div class="position-absolute top-0 end-0 p-3">
                    ...
                    <div class="p-4 d-flex flex-column flex-grow-1">
                        ...
                        <p class="text-muted mb-4 flex-grow-1">A custom Content Management System for writing, editing, and publishing blog posts with user authentication.</p>
                        <div class="d-flex flex-wrap gap-2 mb-4">
